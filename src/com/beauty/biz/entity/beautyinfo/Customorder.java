...
/**
 * 订单表
 * Customorder entity. @author MyEclipse Persistence Tools
 */
@Entity
@Table(name = "customorder")
public class Customorder implements java.io.Serializable {
	...
	/** full constructor */
	public Customorder(String orderid, String ordercode, String ordertype,
