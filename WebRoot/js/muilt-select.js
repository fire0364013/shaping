	...
	function createMovableOptions(fromBox,toBox,attch,totalWidth,totalHeight,labelLeft,labelRight)     
	{                 
		fromObj = document.getElementById(fromBox);         
		toObj = document.getElementById(toBox);
		attchObj = document.getElementById(attch);
