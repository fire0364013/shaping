...
},beforePageText:"第",afterPageText:"页，总共 {pages}  页",displayMsg:""};
})(jQuery);
(function($){
function _7d(_7e){
var _7f=$(_7e);
		...
		if(colCount==0){
			for(var i=0;i<data.columns.length;i++){
				var col = {
					...
					checkbox:data.columns[i].checkbox
				};
				cols.push(col);
			}
			if(opts.columns){
//				_42d($(this));
				var view =$("#"+opts.tableName).parent().find("div.datagrid-view2");
				var inner = view.children("div.datagrid-header").children("div.datagrid-header-inner");
				_436(inner,opts.columns,false);
				function _436(_43a,_43b,_43c){
				if(!_43b){
				return;
				}
