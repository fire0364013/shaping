...
function dTree(objName) {
	...
	this.icon = {
		root				: rootPath + '/images/base.gif',
		folder			: rootPath + '/images/folder.gif',
		folderOpen	: rootPath + '/images/folderopen.gif',
		node				: rootPath + '/images/page.gif',
		empty				: rootPath + '/images/empty.gif',
		line				: rootPath + '/images/line.gif',
		join				: rootPath + '/images/join.gif',
		joinBottom	: rootPath + '/images/joinbottom.gif',
		plus				: rootPath + '/images/plus.gif',
		plusBottom	: rootPath + '/images/plusbottom.gif',
		minus				: rootPath + '/images/minus.gif',
		minusBottom	: rootPath + '/images/minusbottom.gif',
		nlPlus			: rootPath + '/images/nolines_plus.gif',
		nlMinus			: rootPath + '/images/nolines_minus.gif'
	};
	this.obj = objName;
	this.aNodes = [];
	this.aIndent = [];
