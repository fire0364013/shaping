	$(function(){
			...
			$('#datagrid1').datagrid({
				...
				striped: true,
				collapsible:true,
				url:rootPath+"/group/departmentgroup!toOneAndManyList2.action?groupid="+groupid+"&itemid="+itemid+"&methodid="+methodid,//toOneList.action?deptid="+deptid+"&groupid="+groupid,
				fit:true,
				//fitColumns:true,
				remoteSort: false,
				idField:'userid',
