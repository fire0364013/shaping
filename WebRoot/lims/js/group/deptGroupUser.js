	$(function(){
			...
			$('#datagrid1').datagrid({
				...
				striped: true,
				collapsible:true,
				url:rootPath+"/group/departmentgroup!toOneAndManyList.action?deptid="+deptid,//toOneList.action?deptid="+deptid+"&groupid="+groupid,
				fit:true,
				fitColumns:true,
				remoteSort: false,
				idField:'userid',
				...
				columns:[[
						{field:'realname',title:'姓名',width:400,align:"center"}					
				]],
				onSelect:function(){
