	...
	$('#sampleItemDatagrid').datagrid(
		{
			...
			striped : true,
			collapsible : true,
			url : rootPath+'/sampletest/sample/sampletestbysample!updateRecordList.action?samplecode='+samplecode,//+'&itemid='+itemid, 
	...
	$('#updateRecordDatagrid').datagrid(
		{
			...
			striped : true,
			collapsible : true,
			url : rootPath+'/sampletest/sampletestresultupdate!sampletestresultupdateList.action?testresultid='+testresultid, 
