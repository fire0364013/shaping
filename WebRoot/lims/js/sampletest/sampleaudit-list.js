...
function initProjectDatagrid(){
		$('#projectDatagrid').datagrid({
			...
			striped: true,
			collapsible:true,
			url:'sampletestbysample!sampleAuditList.action',
...
//					$('#taskSchemeFrame').attr("src",rootPath+"/sampletest/sample/sampletestbysample!toMonitorPointAudit.action?flag=flag&projectid="+rowData.projectcode);
					projectid = rowData.projectcode;
					flag='noflag';
					initMonitorinfoTree(flag);
				}/*else{
					$('#taskSchemeFrame').attr("src",rootPath+"/sampletest/sample/sampletestbysample!toMonitorPointAudit.action?flag=noflag&projectid=''&entid=''");
				}*/
			},
			onClickRow:function(rowIndex, rowData){				
//				$('#taskSchemeFrame').attr("src",rootPath+"/sampletest/sample/sampletestbysample!toMonitorPointAudit.action?flag=noflag&projectid="+rowData.projectcode);
				projectid = rowData.projectcode;
				flag='noflag';
				initMonitorinfoTree(flag);
				selectTab("待签发信息");
