	function initDataTree() { 
		var myur=rootPath+"/monitorproject/samperegister/samperegister!sampleTagCodeListTwo.action?projectcode="+projectcode+"&projectid="+projectid+"&monitorpointtypeid="+monitorpointtypeid+"&monitorpointid="+monitorpointid;
		 initDataGrid(myur);
	}
