$(function(){
	var documentWidth=document.body.clientWidth;
			$('#selectitem').datagrid({
				...
				striped: true,
				collapsible:true,
			 	url:rootPath +"/projects/taskincept/taskincept!getItemList.action",
				fit:true,
				fitColumns : true,
				scrollbarSize:0,
				remoteSort: false,
				...
				columns:[[
					{field:'itemtypename',title:'监测类型',width:140,align:"center"}	,
					{field:'itemname',title:'监测项目',width:140,align:"center"}	
				]],
				rownumbers:true,
