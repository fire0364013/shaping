...
<html>
  <head>
    <title>角色管理</title>
		...
		<script type="text/javascript" src="${ctx}/lims/js/role.js"></script>
  ...
  <body>
	<table class="Main_Tab_Style" style="width: 100%; height: 22px">
		<tr>
			<td class="Main_Tab_Style_title" style="width: 10%;">角色名称:</td>
			<td class="Main_Tab_Style_Content" style="width: 15%;">	
				<input type="text" name="rolename" id="rolename" class="TextBox" style="width:150px;"/>
			</td>					
			<td>
	...
	<div class="grid-headerSpace">
		<input type="button" value="添加" class="Button_out" onClick="editRole('')" />&nbsp;
		<input type="button" value="删除" class="Button_out" onClick="deleteRoles()" />
	</div>
