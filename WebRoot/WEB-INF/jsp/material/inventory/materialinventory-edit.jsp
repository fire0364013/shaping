			...
			<table width="100%" border="1" align="center" class="grid">
				<tr>
					...
					<td align="left" class="Main_Tab_Style_Content" style="width: 170px; height: 20px;">
						<input type="text" name="materialname" id="materialname" readonly="readonly" class="TextBox" 
							value="${material.materialname}" style="width: 150px; height: 20px;" />
					...
					<input type="text" id="modelname"   class="TextBox"   value="${materialmodel.modelname}" style="width: 150px; height: 20px;" readonly="readonly" />
					<input type="hidden" id="modelid" name="modelid"  class="TextBox"   value="${materialmodel.materialmodelid}" style="width: 150px; height: 20px;"/>
					</td>
				...
				<tr>
					...
					<td align="left" class="Main_Tab_Style_Content">
						<input type="text" id="storgetime" name="storgetime" value="${storgetime}"
							class="Wdate" onClick="showDataTimeDailog('yyyy-MM-dd');"
					 ...
					 <td align="left" class="Main_Tab_Style_Content">
						<select class="TextBox grkj-validate" name="materialinventory.warehouseid.warehouseid" 	validateParam="{type:'string',required:'true',message:'请选择仓库！'}" 
							...
							<c:forEach var="pList" items="${warehouseList }">
								...
								<c:if test="${pList.warehouseid==warehouseid.warehouseid }">selected="selected"</c:if>>
									${pList.warehousename}
								</option>
							</c:forEach>
				...
				<td align="left" class="Main_Tab_Style_title"
					...
					<td align="left" class="Main_Tab_Style_Content">
						<input type="text" name="storgetime" value="${storgetime}"
							class="Wdate" onClick="showDataTimeDailog('yyyy-MM-dd HH:mm');"
						validateParam="{type:'int',required:'true',message:'入库时间不能为空！'}"
								 style="width: 150px;" />
								 <font color="red" size="4px">*</font>
					</td>
				</tr>--%>
				<tr>
					...
					<td align="left" class="Main_Tab_Style_Content">
						<input type="text" name="storagenum" value="${storagenum}"	class="TextBox " readonly="readonly" style="width: 150px;" />
					</td>
					<td align="left" class="Main_Tab_Style_title"
					...
					<td align="left" class="Main_Tab_Style_Content" style="width: 170px; height: 20px;">
						<input type="text" name="remainingnum" id="remainingnum" value="${remainingnum}"
						class="TextBox grkj-validate" validateParam="{type:'int',required:'true',message:'入库数量必须为数字且不能为空！'}" 
						 style="width: 150px; height: 20px;"/> <font color="red" size="4px">*</font>
					</td>
				</tr>
				<tr>
					<td align="left" class="Main_Tab_Style_title"
					...
					<td align="left" class="Main_Tab_Style_Content" style="width: 170px; height: 20px;" colspan="3">
						<input type="text" name="providername" id="providername" value="${providerid.providername}"
					...
					<td colspan="3" align="left" class="Main_Tab_Style_Content">
						<textarea class="TextBox grkj-validate"  
							validateParam="{type:'string',maxLength:'500',required:'false',message:'长度不超过500个字符！'}"   
								 style="width: 425px; height: 80px;" name="remark" >${remark}</textarea>
					</td>
				</tr>
