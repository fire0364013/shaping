			...
			<table width="100%" border="1" align="center" class="grid">
				<tr>
					...
					<td align="left" class="Main_Tab_Style_Content" width="200px">
						<select style="width: 150px;height:20px" name="bigTypeName" class="grkj-validate" validateParam="{type:'string',maxLength:'80',required:'true',message:'物品大类型不能为空'}" >  
				...
				<tr>
					...
					<td align="left" class="Main_Tab_Style_Content" width="200px">
						<input name="equalsName" class="TextBox grkj-validate"
							style="width: 150px;height:20px"  value="${meaterialname}"
							validateParam="{type:'string',maxLength:'80',required:'true',message:'物品类型不能为空，长度不超过80个字符！'}" />
