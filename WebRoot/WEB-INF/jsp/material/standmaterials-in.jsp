		...
		<form id="toinframe" method="post" enctype="multipart/form-data">
			...
			<table width="100%" border="1" align="center" class="grid">
				<tr>
					...
					<td align="left" class="Main_Tab_Style_Content" style="width: 180px; height: 20px;">
				...
				<tr>
					...
					<td align="left" class="Main_Tab_Style_Content">						
						<input type="text" name="materialinventory.batchno" validateParam="{type:'string',required:'true',message:'请填写批号'}" class="TextBox grkj-validate" value="${materialinventory.batchno}" style="width: 160px; height: 20px;" />
					...
					<td align="left" class="Main_Tab_Style_Content">
						<input type="text" name="materialinventory.dilutionmultiple" value="${materialinventory.dilutionmultiple}" class="TextBox" style="width: 160px;"/>
					</td>
					</tr>
					<tr>
					<td align="left" class="Main_Tab_Style_title" style="width: 80px; height: 20px;">
					...
					<td align="left" class="Main_Tab_Style_Content" colspan="3">
						<input type="text" name="materialinventory.consistence" value="${materialinventory.consistence}" class="TextBox grkj-validate" validateParam="{type:'string',required:'true',message:'请输入浓度！'}"  style="width: 450px;"/><font color="red" size="4px"> *</font>
					</td>
				</tr>
					<tr>
					<td align="left" class="Main_Tab_Style_title" style="width: 100px; height: 20px;">
					...
					<td align="left" class="Main_Tab_Style_Content" colspan="3">
						<input type="text" name="materialinventory.uncertainty" value="${materialinventory.uncertainty}" class="TextBox"    style="width: 450px;"/>
					</td>
				...
				<td align="left" class="Main_Tab_Style_title"
					...
					<td align="left" class="Main_Tab_Style_Content">
						<input type="text" name="materialinventory.userinfo.realname" id="personname" validateParam="{type:'string',required:'false',message:'请填写保管人'}" onclick="showName()" class="TextBoxPic grkj-validate" value="${materialinventory.userinfo.realname}" style="width: 160px;"/>
					</td>
				</tr>
				<tr>
					<td align="left" class="Main_Tab_Style_title" style="width: 100px; height: 20px;">
					...
					<td align="left" class="Main_Tab_Style_Content">
						<input type="text" name="materialinventory.expirationdate" id="expirationdate" onClick="showDataTimeDailog('yyyy-MM-dd');" class="Wdate"  value="${materialinventory.expirationdate}" style="width: 160px;"/>
						<font color="red" size="4px">*</font>
					</td>
					<td align="left" class="Main_Tab_Style_title"
				...
				<tr>
					...
					<td align="left" class="Main_Tab_Style_Content">
					<input type="text" name="materialinventory.depositplace" class="TextBox " value="${materialinventory.depositplace}" style="width: 160px; height: 20px;" />
					</td>
					<td align="left" class="Main_Tab_Style_title" style="width: 80px; height: 20px;">
						存放条件：
					</td>
					<td align="left" class="Main_Tab_Style_Content">
						<input type="text" name="materialinventory.depositcondition" class="TextBox" value="${materialinventory.depositcondition}"  style="width: 160px; height: 20px;" />
					</td>
				</tr>
				<tr>
					...
					<td align="left" class="Main_Tab_Style_Content">
						<input type="text" name="materialpurchase.reallynumber" id="reallynumber" value="${materialpurchase.reallynumber}" class="TextBox" style="width: 160px;" readonly="readonly"/>
					</td>
					</tr>
				<tr>
					<td align="left" class="Main_Tab_Style_title" style="width: 80px; height: 20px;">
					...
					<td align="left" class="Main_Tab_Style_Content">
						<input type="text" name="materialpurchase.purchasenumber" id="purchasenumber" value="${materialpurchase.purchasenumber}" class="TextBox" style="width: 160px;" readonly="readonly"/>
					</td>
				</tr>	
				<tr>
				<td align="left" class="Main_Tab_Style_title" style="width: 100px; height: 20px;">
					...
					<td align="left" class="Main_Tab_Style_Content" colspan="3">
						...
						class="TextBoxPic"  style="width: 450px; height: 20px;" onclick="selecTmaterialFocus()"/>
