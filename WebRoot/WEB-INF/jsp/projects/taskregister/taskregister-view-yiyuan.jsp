		...
		<table style="width: 100%;" border="1" align="center" class="grid">
					...
					<tr>
						...
						<td align="left" class="Main_Tab_Style_Content" style="width: 150px; height: 20px;">
							<select id="paymenttype" name="project.paymenttype" style="width: 150px; height: 20px;" disabled>
					...
					<tr>
						...
						<textarea  name="project.intentioniteminfo" class="TextBox grkj-validate"  style="width: 550px; height: 60px;" disabled
					...
					<tr>
						...
						<td align="left" class="Main_Tab_Style_Content" >
							...
							<input type="text"  id="doctorname" class="TextBoxPic  grkj-validate" 			disabled											 
						...
						<td align="left" class="Main_Tab_Style_Content">
							<input type="text" id="doctorphone" class="TextBox grkj-validate" 		disabled				 
					...
					<tr>
						...
						<td align="left" class="Main_Tab_Style_Content" >
							...
							<input type="text"  id="counselorname" class="TextBoxPic  grkj-validate" 	disabled													 
						...
						<td align="left" class="Main_Tab_Style_Content">
							<input type="text" id="counselorphone" class="TextBox" 		disabled				 
					...
					<tr>
						...
						<td colspan="3" align="left" class="Main_Tab_Style_Content" >
							<input type="hidden" id="itemid" name="itemid" value="${itemid}"/>
							<textarea id="itemname" class="TextBox grkj-validate"  style="width: 550px; height: 60px;" onclick="selectItem()" disabled
							validateParam="{type:'string',required:'true',message:'请选择检测项目！'}">${itemname}</textarea><font color="red" size="4px"> *</font>
						</td>
					</tr>		
					<tr> 
						...
						<td colspan="3" align="left" class="Main_Tab_Style_Content">
							<textarea  name="project.isreturn" class="TextBox "  style="width: 550px; height: 60px;" disabled
					...
					<tr> 
						...
						<td colspan="3" align="left" class="Main_Tab_Style_Content">
							<textarea  name="project.remark" class="TextBox grkj-validate"  style="width: 550px; height: 60px;" disabled
