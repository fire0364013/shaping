	...
	<body  onkeydown="PreventBSK()" class="easyui-layout">
		...
		<div region="west" split="true" title="任务信息" style="width:310px;">
			<div class="grid-headerSpace" style="height:23px;">
				<input type="button" value="提交" class="Button_out" onclick="modifyWorkflow()" />
		...
		<div region="center" title="">
			<div id="tt" class="easyui-tabs" fit="true">
	            ...
	            <div title="客户信息" style="display: block;">
					<iframe id="CustomFrame" width="100%" height="100%" frameborder="0" scrolling="auto" src=""></iframe>
				</div>							 
			</div>
		</div>
	</body>
