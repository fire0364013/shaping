...
<html>
	<head>
		...
		<script type="text/javascript" src="${ctx}/lims/js/projects/custom.select.js"></script>
	</head>
			...
			<table width="100%" border="1" align="center" class="grid">
				<tr>
					...
					<td align="left" class="Main_Tab_Style_Content" width="150px">
						<input type="text" id="customname" class="TextBox"	style="width: 100%;">
					</td>
					<!-- 
					<td align="left" class="Main_Tab_Style_title"
						style="width: 100px; height: 20px;">
					...
					<td align=center class="Main_Tab_Style_Content">
						...
						<input type="button" value="新增客户" class="Button_out" onClick="editCustominfo()" />
					</td>
				</tr>
			</table>
